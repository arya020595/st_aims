...
import { hideLoadingSpinner } from "./App";
...
export const InlineNotificationBar = () => {
  ...
  return (
    <div
      className={`flex w-full px-4 justify-between border-b ${LEVEL_CLASSNAMES[notificationState?.type]
        }`}
    >
...
export const InlineNotificationCard = () => {
  ...
  return (
    <div className="p-4">
      <div
        className={`flex w-full px-4 justify-between border border-b-4 rounded-md ${LEVEL_CLASSNAMES[notificationState?.type]
          }`}
      >
        <div className="px-3 py-4">
          <i className={LEVEL_ICON[notificationState?.type]} />{" "}
