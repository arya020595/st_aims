    ...
    <div className={`bg-white shadow-md pt-4 min-h-screen overflow-y-scroll`}>
      <div className="sticky top-0 flex-1">
        <div className="flex items-center">
          <img className="h-20 pl-4" src="/doa/images/doa-logo.png" />
          <div className="mx-4">
        ...
        {menuState === "dashboard" ? (
          <div>
            <div className="bg-mantis-500 rounded-l-lg rounded-r-2xl pr-4">
              ...
              >
                <img src="/doa/images/menu-01_dasboard_icon.svg" />
        ...
        {menuState === "basic_cocoa_statistic" ? (
          <div>
            <div className="bg-mantis-500 rounded-l-lg rounded-r-2xl pr-4">
              ...
              >
                <img src="/doa/images/menu-03_basic_cocoa_statistic_icon.svg" />
                <p className={"text-black font-bold text-lg  mx-2"}>
        ...
        {menuState === "profile" ? (
          <div>
            <div className="bg-mantis-500 rounded-l-lg rounded-r-2xl pr-4">
              ...
              >
                <img src="/doa/images/menu-06_profile_icon.svg" />
        ...
        {menuState === "master_data" ? (
          <div>
            <div className="bg-mantis-500 rounded-l-lg rounded-r-2xl pr-4">
              ...
              >
                <img src="/doa/images/menu-07_master-data_icon.svg" />
                <p className={"text-black font-bold text-lg  mx-2"}>
                  Master Data
                </p>
              </div>
