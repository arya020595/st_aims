...
const cropsDashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/miscellaneous-crops/miscellaneous-dashboard",
      query: {
        ...router.query,
    ...
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen flex justify-center">
        <iframe
          ...
          width="100%"
          height="100%"
          src="https://app.powerbi.com/view?r=eyJrIjoiMzk3YzY4ZjUtMmY1NC00ZGI2LWEzNGItZDBhZjZmZWIxOGY4IiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
          frameborder="0"
