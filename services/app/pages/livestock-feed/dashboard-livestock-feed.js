...
const Dashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/livestock-feed/dashboard-livestock-feed",
      query: {
        ...router.query,
  ...
  return (
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen bg-[#F7FFF6]">
        {!currentUserDontHavePrivilege(["Dashboard Livestock Feed"]) ? (
          <iframe
            title="DoAA_LivestockFeedDashboards"
            width="100%"
            height="100%"
            src="https://app.powerbi.com/view?r=eyJrIjoiNDY4ZTFjY2MtZDAyNy00MzhiLTllZTgtMjhhYjlkNzI4Yjg0IiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
            frameborder="0"
