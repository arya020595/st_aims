...
const cropsDashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/floriculture-crops/dashboard-floriculture",
      query: {
        ...router.query,
    ...
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen flex justify-center">
        <iframe
          ...
          width="100%"
          height="100%"
          src="https://app.powerbi.com/view?r=eyJrIjoiOTY5MTljZGUtZGE3Ni00YTMwLTk0NjktYjlkMDVjNGExNDAwIiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
          frameborder="0"
