...
const cropsDashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/fruit-crops/fruit-dashboard",
      query: {
        ...router.query,
    ...
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen flex justify-center">
        <iframe
          ...
          width="100%"
          height="100%"
          src="https://app.powerbi.com/view?r=eyJrIjoiYTEyYzQ1NDctM2VjMi00ZmFhLThlNTctMGFlNzc0MjRkMmZlIiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
          frameborder="0"
