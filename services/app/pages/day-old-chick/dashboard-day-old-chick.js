...
const Dashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/day-old-chick/dashboard-day-old-chick",
      query: {
        ...router.query,
  ...
  return (
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen bg-[#F7FFF6]">
        {!currentUserDontHavePrivilege(["Dashboard Day Old Chick:Read"]) ? (
          <iframe
            title="DoAA_DocDashboards"
            width="100%"
            height="100%"
            src="https://app.powerbi.com/view?r=eyJrIjoiYmFlODczNTMtZWQ5NS00MWQzLThhZjctOWI3ZGQxNzE0NzI0IiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
            frameborder="0"
