...
const Dashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/ruminant/dashboard-ruminant",
      query: {
        ...router.query,
  ...
  return (
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen bg-[#F7FFF6]">
        {!currentUserDontHavePrivilege(["Dashboard Ruminant Livestock:Read"]) ? (
          <iframe
            title="DoAA_RuminantDashboards"
            width="100%"
            height="100%"
            src="https://app.powerbi.com/view?r=eyJrIjoiZjBhOTQwYTUtMDY0My00NmZlLTgyMmEtNWU1MDA1Njk0M2JkIiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
            frameborder="0"
