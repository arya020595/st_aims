    ...
    <AdminArea urlQuery={router.query}>
      ...
      >
        <div className="form-group">
          ...
          <input
            ...
            value={(formData.typesOfCompany || "").toUpperCase()}
            onChange={(e) => {
              if (e) e.preventDefault();
              setFormData({
                ...formData,
      ...
      <div className="mt-26 pr-0 md:pr-10 py-4 h-full">
        <Table
          ...
          withoutHeader={true}
          onAdd={
            !currentUserDontHavePrivilege(["Type Company Reg:Create"])
              ? (e) => {
                  if (e) e.preventDefault();
                  setModalVisible(true);
                  setFormData({});
          ...
          onRemove={
            !currentUserDontHavePrivilege(["Type Company Reg:Delete"])
              ? async ({ rows }) => {
                  showLoadingSpinner();
                  try {
                    let yes = confirm(
          ...
          customUtilities={
            !currentUserDontHavePrivilege(["Type Company Reg:Update"])
              ? customUtilities
              : null
          }
