    ...
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-26 pr-0 md:pr-10 py-4 h-full">
        <Table
          ...
          withoutHeader={true}
          onAdd={
            !currentUserDontHavePrivilege(["Irrigation Status:Create"])
              ? (e) => {
                  if (e) e.preventDefault();
                  setModalVisible(true);
                  setFormData({});
          ...
          onRemove={
            !currentUserDontHavePrivilege(["Irrigation Status:Delete"])
              ? async ({ rows }) => {
                  showLoadingSpinner();
                  try {
                    let yes = confirm(
          ...
          customUtilities={
            !currentUserDontHavePrivilege(["Irrigation Status:Update"])
              ? customUtilities
              : null
          }
