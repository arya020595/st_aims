    ...
    <AdminArea urlQuery={router.query}>
      ...
      >
        <div className="form-group">
          ...
          <input
            ...
            value={(formData.supports || "").toUpperCase()}
            onChange={(e) => {
              if (e) e.preventDefault();
              setFormData({
                ...formData,
      ...
      <div className="mt-26 pr-0 md:pr-10 py-4 h-full">
        <Table
          ...
          withoutHeader={true}
          onAdd={
            !currentUserDontHavePrivilege(["Support Type:Create"])
              ? (e) => {
                  if (e) e.preventDefault();
                  setModalVisible(true);
                  setFormData({});
          ...
          onRemove={
            !currentUserDontHavePrivilege(["Support Type:Delete"])
              ? async ({ rows }) => {
                  showLoadingSpinner();
                  try {
                    let yes = confirm(
          ...
          customUtilities={
            !currentUserDontHavePrivilege(["Support Type:Update"])
              ? customUtilities
              : null
          }
