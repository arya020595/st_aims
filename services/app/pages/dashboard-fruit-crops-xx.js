...
const FruitDashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/fruit-crops/dashboard-fruit-crops",
      query: {
        ...router.query,
  ...
  return (
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen flex justify-center">
        <iframe
          title="DoAA FRUIT Dashboard"
          width="100%"
          height="100%"
          src="https://app.powerbi.com/view?r=eyJrIjoiNjg0ZTkzZjgtM2I3My00NjFkLWFjOTAtYWE0MzNiOWQzYWRhIiwidCI6IjNiNmFjMTJhLTgwMDAtNGYwZS1iYmMyLWYwNzhiNTY0NGFlNiIsImMiOjEwfQ%3D%3D"
          frameborder="0"
...
export default withApollo({ ssr: true })(FruitDashboard);
