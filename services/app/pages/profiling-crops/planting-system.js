...
const CREATE_PLANTING_SYSTEM = gql`
  mutation tokenizedCreatePlantingSystem($tokenized: String!) {
    tokenizedCreatePlantingSystem(tokenized: $tokenized)
  }
`;

const UPDATE_PLANTING_SYSTEM = gql`
  mutation tokenizedUpdatePlantingSystem($tokenized: String!) {
    tokenizedUpdatePlantingSystem(tokenized: $tokenized)
  }
`;

const DELETE_PLANTING_SYSTEM = gql`
  mutation tokenizedDeletePlantingSystem($tokenized: String!) {
    tokenizedDeletePlantingSystem(tokenized: $tokenized)
  }
`;
        ...
        <Table
          ...
          onAdd={
            !currentUserDontHavePrivilege([
              "Planting System Profiling Crops:Create",
            ])
              ? (e) => {
                  if (e) e.preventDefault();
                  setModalVisible(true);
          ...
          onRemove={
            !currentUserDontHavePrivilege([
              "Planting System Profiling Crops:Delete",
            ])
              ? async ({ rows }) => {
                  showLoadingSpinner();
                  try {
          ...
          customUtilities={
            !currentUserDontHavePrivilege([
              "Planting System Profiling Crops:Update",
            ])
              ? customUtilities
              : null
          }
