              ...
              onClick={(e) => {
                ...
                let allVillages = allFarmLocations.filter(
                  (loc) =>
                    ...
                    loc.mukim === propsTable.row.original.farmMukim
                );
                ...
                let allAreas = allFarmLocations.filter(
                  (loc) =>
                    loc.district === found.district &&
                    loc.mukim === propsTable.row.original.farmMukim &&
                    loc.village === propsTable.row.original.farmVillage
                );
                // console.log({
        ...
        <div className="form-group">
          ...
          <input
            ...
            onChange={(e) => {
              ...
              setFormData({
                ...formData,
                partnerInvestor: e.target.value,
              });
            }}
          />
        </div>
            ...
            <div className="form-group">
              ...
              >
                ...
                {allContractStatuses.map((stat) => (
                  <option value={stat.uuid}>{stat.status}</option>
                ))}
              </select>
            </div>
            ...
            <div className="form-group">
              ...
              >
                ...
                {allLandOwnershipStatuses.map((owner) => (
                  <option value={owner.uuid}>{owner.status}</option>
                ))}
              </select>
            </div>
          ...
          {allComodityTypes.map((comodity) => {
            ...
            return (
              <div>
                ...
                />
                <label>{comodity.comodityType}</label>
              </div>
            );
          })}
        </div>
            ...
            <div className="form-group">
              ...
              >
                ...
                {allAwardTypes.map((awd) => (
                  <option value={awd.uuid}>{awd.award}</option>
                ))}
              </select>
            </div>
            <div className="form-group">
            ...
            <div className="form-group">
              ...
              >
                ...
                {allModernTechnologies.map((tech) => (
                  <option value={tech.uuid}>{tech.name}</option>
                ))}
              </select>
            </div>
            <div className="form-group">
