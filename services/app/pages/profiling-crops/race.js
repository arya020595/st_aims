    ...
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-26 pr-0 md:pr-10 py-4 h-full">
        <Table
          ...
          withoutHeader={true}
          onAdd={
            !currentUserDontHavePrivilege(["Race Profiling Crops:Create"])
              ? (e) => {
                if (e) e.preventDefault();
                setModalVisible(true);
                setFormData({});
          ...
          onRemove={
            !currentUserDontHavePrivilege(["Race Profiling Crops:Delete"])
              ? async ({ rows }) => {
                showLoadingSpinner();
                try {
                  let yes = confirm(
          ...
          customUtilities={
            !currentUserDontHavePrivilege(["Race Profiling Crops:Update"])
              ? customUtilities
              : null
          }
