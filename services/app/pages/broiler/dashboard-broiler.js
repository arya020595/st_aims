...
const Dashboard = () => {
  ...
  useEffect(() => {
    router.replace({
      pathname: "/broiler/dashboard-broiler",
      query: {
        ...router.query,
  ...
  return (
    <AdminArea urlQuery={router.query}>
      ...
      <div className="mt-28 h-screen bg-[#F7FFF6]">
        {!currentUserDontHavePrivilege(["Dashboard Broiler:Read"]) ? (
          <iframe
            title="DoAA_BroilerDashboards"
            width="100%"
            height="100%"
            src="https://app.powerbi.com/view?r=eyJrIjoiMTUxZDNkNDktM2FjOC00NjA3LTg4N2EtZDhiMzExYzVjYThlIiwidCI6IjljN2ZiNmU3LTM0YzUtNGMyZS1hYTVjLWJhZjAyY2E2MzcxMSIsImMiOjEwfQ%3D%3D"
            frameborder="0"
