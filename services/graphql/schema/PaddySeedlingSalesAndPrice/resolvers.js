...
const resolvers = {
  Query: {
    allPaddySeedlingSalesAndPrices: async (self, params, context) => {
      ...
      if (
        !role ||
        !role.privileges.includes("Paddy Seedling Sales Price:Read")
      ) {
        return [];
      }
      ...
      if (profileQuery.rocbnRegNo) {
        ...
        const found = await context.prisma.paddySeedlingSalesAndPrice.findMany({
          where: {
            farmerUUID: {
        ...
        let queryResult =
          await context.prisma.paddySeedlingSalesAndPrice.findMany({
            where: {
              ...filterQuery,
              ...NOT_DELETED_DOCUMENT_QUERY,
            },
    ...
    tokenizedAllPaddySeedlingSalesAndPrices: async (self, params, context) => {
      assertValidSession(context.activeSession);
      ...
      if (profileQuery.rocbnRegNo) {
        ...
        // let countPaddySeedlingSalesAndPrice = await context.prisma.paddySeedlingSalesAndPrice.findMany({
        //   where: {
        //     farmerUUID: {
        //       in: getCompany.map((c) => c.uuid),
        //     },
        ...
        // countPaddySeedlingSalesAndPrice = countPaddySeedlingSalesAndPrice.length

        // const pages = Math.ceil(countPaddySeedlingSalesAndPrice / params.pageSize)

        let found = await context.prisma.paddySeedlingSalesAndPrice.findMany({
          where: {
            farmerUUID: {
              in: getCompany.map((c) => c.uuid),
            },
        ...
        // let countPaddySeedlingSalesAndPrice =
        //   await context.prisma.paddySeedlingSalesAndPrice.findMany({
        //     where: {
        //       ...filterQuery,
        //       ...NOT_DELETED_DOCUMENT_QUERY,
        ...
        let farmerUUIDsQuerys = queryResult
          .filter((q) => q.farmerUUID)
          .map((q) => q.farmerUUID);
        farmerUUIDsQuerys = lodash.uniq(farmerUUIDsQuerys);
        let farmerProfile = await context.prisma.farmerProfile.findMany({
          where: {
            uuid: {
              in: farmerUUIDsQuerys,
            },
            // ...NOT_DELETED_DOCUMENT_QUERY,
          },
        });
    ...
    countAllPaddySeedlingSalesAndPrices: async (self, params, context) => {
      assertValidSession(context.activeSession);
      ...
      if (profileQuery.rocbnRegNo) {
        ...
        let found = await context.prisma.paddySeedlingSalesAndPrice.count({
          where: {
            farmerUUID: {
              in: getCompany.map((c) => c.uuid),
            },
        ...
        let queryResult = await context.prisma.paddySeedlingSalesAndPrice.count(
          {
            where: {
              ...filterQuery,
              ...NOT_DELETED_DOCUMENT_QUERY,
  ...
  Mutation: {
    createPaddySeedlingSalesAndPrice: async (self, params, context) => {
      assertValidSession(context.activeSession);
      ...
      await context.prisma.paddySeedlingSalesAndPrice.create({
        data: {
          ...createPayload,
        },
      });
      ...
      await context.prisma.activityLogs.create({
        data: {
          uuid: uuidv4(),
          type: "CREATE",
          tableName: "paddySeedlingSalesAndPrice",
          log: {
            ...createPayload,
          },
        },
    ...
    updatePaddySeedlingSalesAndPrice: async (self, params, context) => {
      assertValidSession(context.activeSession);

      await context.prisma.paddySeedlingSalesAndPrice.update({
        where: {
          uuid: params.uuid,
        },
        data: {
    ...
    deletePaddySeedlingSalesAndPrice: async (self, params, context) => {
      assertValidSession(context.activeSession);

      let getDeletedData =
        await context.prisma.paddySeedlingSalesAndPrice.findUnique({
          where: {
            uuid: params.uuid,
          },
        });
    ...
    exportPaddySeedlingSalesPrice: async (self, params, context) => {
      assertValidSession(context.activeSession);
      ...
      if (
        ...
        productions = await context.prisma.paddySeedlingSalesAndPrice.findMany({
          where: {
            ...filterQuery,
            ...NOT_DELETED_DOCUMENT_QUERY,
            farmerUUID: {
      ...
      let productionSheet = workbook.addWorksheet(
        "Paddy Seedling Sales Price Production"
      );
      ...
      // }
      // const filename = `paddy_seedling_sales_price_production.xlsx`;
      // const fileUrl =
    ...
    tokenizedCreatePaddySeedlingSalesAndPrice: async (
      self,
      params,
      context
    ) => {
    ...
    tokenizedUpdatePaddySeedlingSalesAndPrice: async (
      self,
      params,
      context
    ) => {
    ...
    tokenizedDeletePaddySeedlingSalesAndPrice: async (
      self,
      params,
      context
    ) => {
