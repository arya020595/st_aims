...
const resolvers = {
  Query: {
    allBioSecurityCountries: async (self, params, context) => {
      ...
      if (!role || !role.privileges.includes("Country Bio Security:Read")) {
        return [];
      }

      let queryResult = await context.prisma.bioSecurityCountry.findMany({
        where: {
    ...
    tokenizedAllBioSecurityCountries: async (Self, params, context) => {
      assertValidSession(context.activeSession);
    ...
    searchCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);
      let nameQuery = {};
      ...
      if (queryResult.length === 0) {
        ...
        queryResult = await context.prisma.bioSecurityCountry.findMany({
          where: {
            ...nameQuery,
            ...NOT_DELETED_DOCUMENT_QUERY,
          },
  ...
  Mutation: {
    createBioSecurityCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);
      ...
      await context.prisma.bioSecurityCountry.create({
        data: {
          ...createPayload,
        },
      });
    ...
    updateBioSecurityCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);
      await context.prisma.bioSecurityCountry.update({
        where: {
          uuid: params.uuid,
        },
        data: {
    ...
    deleteBioSecurityCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);

      let getDeletedData = await context.prisma.bioSecurityCountry.findUnique({
        where: {
          uuid: params.uuid,
        },
      });
    ...
    tokenizedCreateBioSecurityCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);
    ...
    tokenizedUpdateBioSecurityCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);
    ...
    tokenizedDeleteBioSecurityCountry: async (self, params, context) => {
      assertValidSession(context.activeSession);
    ...
    exportBioSecurityCountry: async (self, params, context) => {
      const foundUser = await context.prisma.user.findUnique({
        where: {
          uuid: context.activeSession.User.userId,
        },
      ...
      let countries = await context.prisma.bioSecurityCountry.findMany({
        where: {
          ...NOT_DELETED_DOCUMENT_QUERY,
        },
      });
      ...
      let productionSheet = workbook.addWorksheet("Country");
