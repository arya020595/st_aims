...
const resolvers = {
  Query: {
    allBioSecurityNonComplianceCommercials: async (self, params, context) => {
    ...
    tokenizedAllBioSecurityNonComplianceCommercials: async (
      self,
      params,
      context
    ) => {
  ...
  Mutation: {
    createBioSecurityNonComplianceCommercial: async (self, params, context) => {
      assertValidSession(context.activeSession);

      const uuid = uuidv4();

      await context.prisma.bioSecurityNonComplianceCommercial.create({
        data: {
          uuid,
          ...params,
    ...
    updateBioSecurityNonComplianceCommercial: async (self, params, context) => {
      assertValidSession(context.activeSession);

      await context.prisma.bioSecurityNonComplianceCommercial.update({
        where: {
          uuid: params.uuid,
        },
        data: {
    ...
    deleteBioSecurityNonComplianceCommercial: async (self, params, context) => {
      assertValidSession(context.activeSession);

      let getDeletedData =
        await context.prisma.bioSecurityNonComplianceCommercial.findUnique({
          where: {
            uuid: params.uuid,
          },
        });
    ...
    exportBioSecurityNonComplianceCommercial: async (self, params, context) => {
      assertValidSession(context.activeSession);
    ...
    tokenizedCreateBioSecurityNonComplianceCommercial: async (
      self,
      params,
      context
    ) => {
    ...
    tokenizedUpdateBioSecurityNonComplianceCommercial: async (
      self,
      params,
      context
    ) => {
    ...
    tokenizedDeleteBioSecurityNonComplianceCommercial: async (
      self,
      params,
      context
    ) => {
  ...
  BioSecurityNonComplianceCommercial: {
    id: (self) => {
